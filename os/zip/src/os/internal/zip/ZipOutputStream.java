...
package os.internal.zip;

import static os.internal.zip.ZipConstants.DATA_DESCRIPTOR_MIN_VERSION;
import static os.internal.zip.ZipConstants.DWORD;
import static os.internal.zip.ZipConstants.INITIAL_VERSION;
import static os.internal.zip.ZipConstants.SHORT;
import static os.internal.zip.ZipConstants.WORD;
import static os.internal.zip.ZipConstants.ZIP64_MAGIC;
import static os.internal.zip.ZipConstants.ZIP64_MAGIC_SHORT;
import static os.internal.zip.ZipConstants.ZIP64_MIN_VERSION;
import static os.internal.zip.ZipLong.putLong;
import static os.internal.zip.ZipShort.putShort;
